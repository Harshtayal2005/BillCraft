...
const ClientInfoBox = ({ name, email, userAvatar, removeClient, clientId }) => {
  return (
    <>
      <div className="inline-flex flex-col gap-4 bg-teal-100 rounded-b-2xl rounded-t-[7rem] shadow-[20px_20px_50px_10px_#1a202c]">
        ...
        <div
          ...
          } flex justify-center mb-4 hover:cursor-pointer`}
        >
          <img src="remove.svg" alt="remove" className="h-11 w-11" />
        </div>
      </div>
    </>
  );
